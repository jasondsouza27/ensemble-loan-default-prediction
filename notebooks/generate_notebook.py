"""
Script to generate a rich, complete Jupyter Notebook: Loan_Default_Prediction_Study.ipynb
for academic submission and university viva.
"""
...
out_path = Path(__file__).resolve().parent / "Loan_Default_Prediction_Study.ipynb"
with open(out_path, "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print(f"[+] Successfully generated Jupyter Notebook at {out_path}")
